...
class PhotoSearchController {
    ...
    private func searchPhotoForCheckpoint(_ checkpoint: Checkpoint) {
        ...
        let searchUrl = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(apiKey)&content_type=1&lat=\(checkpoint.latitude)&lon=\(checkpoint.longitude)&extras=url_l&per_page=1&page=1&format=json&nojsoncallback=1"
